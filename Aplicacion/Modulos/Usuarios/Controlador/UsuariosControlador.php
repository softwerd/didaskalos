...
class UsuariosControlador extends ControladorBase
{
    ...
    {
        require_once DIRMODULOS . 'Docentes/Forms/CargaUsuarios.php';
        include_once LIBRERIAS . 'MyFechaHora.php';
        require_once LIBRERIAS . 'BarraHerramientas.php';
        require_once LIBRERIAS . 'Zend/File/Transfer.php';
        $where = implode(',', $arg);
        $usuarioBuscado = $this->_modelo->buscarUsuario($arg);
    ...
    public function listar ($arg='')
    {
        ...
        $grilla->setColModel(array(
            ...
            array('name' => 'Nombre', 'index' => 'nombre', 'width' => '200'),
            array('name' => 'Nombre Usuario', 'index' => 'userName', 'width' => '255'),
            array('name' => 'Categoría', 'index' => 'categoria', 'width' => '55'),
            array('name' => 'Bloqueado', 'index' => 'bloqueado', 'width' => '55', 'align'=>"right"),
            array('name' => 'Enviar EMail', 'index' => 'enviarMail', 'width' => '55', 'align'=>"right"),
            array('name' => 'Activo', 'index' => 'activo', 'width' => '55'),
