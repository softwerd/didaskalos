<?php
require_once LIBRERIAS . 'BotonBarra.php';
...
class BarraHerramientas {
	...
	function __construct() {
		$this->_retorno = "<div id=\"barraherramientas\" class=\"ui-state-default ui-jqgrid-pager ui-corner-all\">\n";
	...
	public function render()
	{
        ...
        {
            $file = LIBRERIAS . 'Html/Boton/' . 'Boton' . ucfirst($class) . '.php';
            if (! file_exists($file)) {
        ...
        public function addBoton($tipo,$arg)
        {
            ...
            $file = LIBRERIAS . 'Html/Boton/' . $clase . '.php';
            require_once ($file);
            $boton = new $clase($arg);
